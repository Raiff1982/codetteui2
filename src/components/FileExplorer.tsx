    ...
    <ErrorBoundary>
      ...
      <TouchGestures>
        <TooltipProvider showBeginnerTips={showBeginnerTips}>
          ...
          {/* Command Palette - Mounted at root level */}
          <CommandPalette
            isOpen={commandPaletteOpen}
          ...
          {/* AI Drawer - Progressive disclosure */}
          <AIDrawer
            isOpen={aiDrawerOpen}
          ...
          {/* Status Toasts - Background work visibility */}
         ...
         <div className="space-y-1">
           {filteredFiles.map((file) => (
             <div
               ...
               className={`flex items-center space-x-3 p-3 rounded-lg cursor-pointer transition-all duration-200 hover:bg-white/60 dark:hover:bg-gray-600/60 backdrop-blur-sm ${
